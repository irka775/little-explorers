...
class StoreSettingsAdmin(admin.ModelAdmin):
    ...
    def is_superuser(self, obj):
        """Returnează True dacă utilizatorul asociat este superuser."""
        return obj.user.is_superuser if obj.user else False

    is_superuser.boolean = True  # Afișează iconița ✔️/❌ în Django Admin
    is_superuser.short_description = "Superuser"  # Numele coloanei în Admin
